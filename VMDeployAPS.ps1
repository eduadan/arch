[CmdletBinding()] Param(
	...
	[Parameter(Position=2,Mandatory=$false)] [switch]$LocalStart2
...
else
{
	if ($LocalStart1)
	{
		...
		set-itemproperty $RunOnceKey "VMDeployAPS" 'C:\Windows\System32\WindowsPowerShell\v1.0\Powershell.exe -executionPolicy Unrestricted -File c:\windows\temp\VMDeployAPS.ps1 -LocalStart2'
